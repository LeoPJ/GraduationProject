...
def write_file(str):
    ...
    :return: 无
    """
    writefile = open("./out/ENG/ENG(code1e)_users.txt", 'a+',encoding='utf-8')
    writefile.write(str + '\n')
    writefile.close()
    # return str
...
if __name__ == '__main__':
    ...
    with open('data/ENG/ENG(code1e)_users.json',encoding='utf-8') as f:
        dicts = json.load(f)
    test_dict = {}
    for d in dicts:
        test_dict[d["no"]] = d['ONE_HOT']
    print(len(test_dict))
