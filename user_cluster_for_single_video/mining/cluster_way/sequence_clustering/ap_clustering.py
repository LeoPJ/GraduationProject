...
def write_file(str):
    ...
    :return: 无
    """
    writefile = open("./out/ap.txt", 'a+',encoding='utf-8')
    writefile.write(str + '\n')
    writefile.close()
    # return str
...
if __name__ == '__main__':
    ...
    with open('data/sequence.json',encoding='utf-8') as f:
        dicts = json.load(f)
    dict = {}
    for d in dicts:
        dict[d["no"]] = d['ONE_HOT']
    ...
    af = AffinityPropagation(preference=-5.4, affinity='precomputed').fit(W)
